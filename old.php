...
<?php 
  ...
  if(!$dbfound) {
    ...
    while ( $db_field = mysql_fetch_assoc($result) ) {
      ...
      print "      </tr>\n"; 
      print "      <tr>\n";
      print "        <td align='right'> XB Duration : </td>\n";
      print "        <td width='45' align='right'>" . $db_field['XBLENGTH'] . "</td>\n"; 
      print "      </tr>\n"; 
      print "      <tr>\n";
      ...
      print "      </tr>\n"; 
      print "      <tr>\n";
      print "        <td align='right'> L2 Threshold : </td>\n";
      print "        <td width='45' align='right'>" . $db_field['L2THRESH'] . "</td>\n"; 
      print "      </tr>\n"; 
      print "      <tr>\n";
